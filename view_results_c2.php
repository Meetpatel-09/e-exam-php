          ...
          <div class="row">
               ...
               <div class="col-sm-8">
                    <div style="margin-top: 15px; text-align: center; display: flex; justify-content: space-around;">
                         <h3 style="text-align: center; display: flex;">Branch: <?php echo $branch ?></h3>
                         <h3 style="text-align: center; display: flex;">Semester: <?php echo $semester ?></h3>
                    </div>
                    <div style="margin-top: 15px;">
                         ...
                         <div style="margin-top: 15px;">
                              ...
                              <a type="button" href="print_result.php?branch=<?php echo $branch; ?>&semester=<?php echo $semester; ?>&date=<?php echo $date; ?>" class="btn btn-primary" style="padding-left: 15px; padding-right: 15px;">
                                   Print
                              </a>
                              </p>
                         </div>
