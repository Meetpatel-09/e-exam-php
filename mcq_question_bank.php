...
if (isset($_SESSION['student_email'])) {
     ...
     $sql5 = "SELECT roll_no, date FROM results WHERE roll_no = ? AND date = ?";
     $stmt2 = mysqli_prepare($conn, $sql5);
     mysqli_stmt_bind_param($stmt2, "ss", $param_roll_no1, $param_date1);
     $param_roll_no1 = $roll_no;
     $param_date1 = $date;
...
?>
               ...
               <div style="margin-top: 15px;">
                    ...
                    <h4 style="text-align: center">Time Remaining: <?php include('timer.php'); ?></h4>
               </div>
